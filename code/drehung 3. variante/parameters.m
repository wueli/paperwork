...
t=0.05;              %delta t
iter=180/0.05;       %number of time iterations, simulated time = iter*t
pxm=15;              %pixel per meter

pers_per_s=8;        %new agents per socond except of agents gettig off the train

train_delay=15;      %time until train arrives
pers_per_s_train=5;  %number of agents per second getting of the train
nof_train=1200;
...
tend=8/360*2*pi;    %angel of rotation of velocity vector

Tau=0.5;             %parameter for force in direction of the destination

A1=1.5*pxm;            %parameter for force of other agents
A2=3*pxm;
B1=0.1*pxm;
B2=0.2*pxm;
r_agents=2*0.3*pxm;
lambda=0.75;
sight_radius=1.5*pxm;
...
p1_paper=0.07;       %probability of beeing a paper taker from agents from starting point 1
p2_paper=0.17;       %probability of beeing a paper taker from agents from starting point 2
p3_paper=0.07;       %...
p4_paper=0.07;
p5_paper=0.07;
