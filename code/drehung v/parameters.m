...
train_delay=13;      %time until train arrives
pers_per_s_train=6;  %number of agents per second getting of the train
nof_train=1200;
...
tend=3/360*2*pi;    %angel of rotation of velocity vector
