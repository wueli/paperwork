...
load('FOX_FOY_W_norm_WY_norm_DistanceMap_ZB.mat')  %load vector files calculatey by runfast.m
parameters; %load parameters.m

for i=1:size(WX_norm,1)   %calculation of repulsion force of the walls
